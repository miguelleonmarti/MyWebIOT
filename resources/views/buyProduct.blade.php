...
@foreach ($productos->chunk(3) as $chunk) <!-- Number of rows -->
    ...
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
        ...
        <form action="/add/{{ $producto->id }}" method="POST" style="all: unset;">
            @csrf
            <button type="submit" class="btn btn-lg btn-outline-primary btn-block align-self-center mt-auto">Comprar</button>
        </form>
      </div>
    </div>
    @endforeach
